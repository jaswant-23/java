...
public class sandwith_Student {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(count_unableToeat(sandwich,student));
    }
    public static int count_unableToeat(int[] sand,int[] stu){
        int rtime = 0;
        int count =0;

        while (rtime<stu.length*2) {
    ...
    public static void rotateEle_1(int[] arr){
        int temp =arr[0];
