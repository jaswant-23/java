...
public class setXORArr {
     ...
     * 
     * You need to calculate the bitwise XOR of each element in the array with its
     ...
     * complete the provided functions. In a new line, print the output.
     * 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nXOR TO N each element");
        printArr(arr.length, arr);

        setToZero(arr.length, arr);
        System.out.println();
        printArr(arr.length, arr);
