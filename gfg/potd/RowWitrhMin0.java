...
public class RowWitrhMin0 {
    /*
     * Row with minimum number of 1's
     * EasyAccuracy: 25.0%Submissions: 40K+Points: 2
     * 
     * Fast-Track your resumes to top tech companies and get the job you deserve!
     * Register for Job-A-Thon Hiring Challenge
     * banner
     * 
     * Given a 2D binary matrix(1-based indexed) a of dimensions nxm , determine the
     ...
     * function minRow() which takes the two integers n, m as well as the 2D binary
     * matrix a as input parameters and returns the minimum index of the row which
     * contains the least number of 1's.
     * 
    ...
    public static void main(String[] args) {
        ...
        int[][] a = { { 1, 1, 1, 1 },
                ...
                { 0, 0, 1, 1 },
                { 1, 1, 1, 1 } };
        System.out.println(Cal_row_with_min_1_fun(a, n, m));

    }

    public static int Cal_row_with_min_1_fun(int[][] arr, int n, int m) {
